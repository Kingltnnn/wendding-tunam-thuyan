...
const Location: React.FC = () => {
  ...
  return (
    <section id="location" className="min-h-screen w-full bg-slate-50 relative flex flex-col items-center justify-center py-16 px-4 overflow-hidden">
      <div className="w-full h-full max-w-5xl flex flex-col relative z-10">
        ...
        {/* Map Container */}
        <Reveal animation="zoom" delay={200} className="h-[400px] md:h-[500px] w-full bg-white rounded-xl shadow-2xl overflow-hidden relative border-4 border-white mx-auto">
            <iframe 
