    ...
    <section id="events" className="min-h-screen w-full relative overflow-hidden flex flex-col bg-gray-900">
       ...
       <div className="relative z-10 flex-1 flex flex-col px-6 md:px-12 py-16 md:py-24 text-white">
          ...
          <div className="mt-auto mb-12 w-full">
             <Reveal animation="slide-left" delay={300} className="flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-8 justify-center">
                ...
                <div className="flex gap-3 md:gap-6">
                   {[
                     ...
                     { label: 'giây', value: timeLeft.seconds }
                      ...
                      <div key={idx} className="bg-white/95 backdrop-blur-sm text-gray-800 rounded-md p-2 md:p-4 w-[65px] md:w-[95px] flex flex-col items-center shadow-xl">
