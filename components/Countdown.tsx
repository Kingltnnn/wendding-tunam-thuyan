...
const Countdown: React.FC = () => {
  return (
    <section id="invitation" className="min-h-screen w-full bg-[#FAFAFA] flex flex-col overflow-hidden relative py-12 md:py-20">
      ...
      <div className="w-full flex flex-col relative z-10 max-w-6xl mx-auto">
        ...
        <Reveal animation="fade-up" className="grid grid-cols-3 gap-2 px-4 md:px-12 h-[30vh] md:h-[45vh] shrink-0 mb-10">
           <div className="h-full overflow-hidden rounded-sm shadow-md">
               <img src="https://i.ibb.co/wF8xCw78/1-D0-A4394-2.jpg" alt="Bride" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
           </div>
           <div className="h-full overflow-hidden rounded-sm shadow-md translate-y-4">
               <img src="https://i.ibb.co/Kcv49tTr/1D0A4232.jpg" alt="Couple" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
           </div>
           <div className="h-full overflow-hidden rounded-sm shadow-md">
               <img src="https://i.ibb.co/JjnSc6Pb/1D0A3821.jpg" alt="Groom" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
           </div>
        </Reveal>
